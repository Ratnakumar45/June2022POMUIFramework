...
public class LoginPage {
	...
	private By forgotPwnLink = By.linkText("Forgotten Password");
	...
	public boolean isForgotPwdLinkExist() {
		return eleUtil.doEleIsDisplayed(forgotPwnLink);
		//return driver.findElement(forgotPwnLink).isDisplayed();
	}
